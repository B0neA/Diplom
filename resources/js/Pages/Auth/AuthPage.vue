...
export default {
  ...
  computed: {
    seo() {
      return this.isLogin
        ? usePageSeo('Вход — Лопать Подано', 'Войдите в аккаунт Лопать Подано, чтобы оформлять заказы и видеть историю доставок.')
        : usePageSeo('Регистрация — Лопать Подано', 'Создайте аккаунт Лопать Подано: сохраняйте адреса, получайте скидки и отслеживайте заказы.');
    },
  },
  data() {
    return {
